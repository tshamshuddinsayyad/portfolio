...
function App() {
  ...
  return <div className="app">
    ...
    <main>
      <section className="hero" id="about">
        <div className="hero-copy">
          <div className="eyebrow"><span className="signal"/> AI SPACE • INTELLIGENCE • DATA • CREATIVE CODE</div>
          <h1>Hi, I'm <em>Tayyab</em><br/>AI Space Builder.</h1>
          <p>{profile.tagline} I design intelligent digital experiences where AI, data, code and interactive technology meet.</p>
        ...
        <div className="hero-console sky-console"><div className="console-top"><span>AI SPACE / COMMAND DECK</span><i>ONLINE</i></div><div className="sky-visual"><div className="sky-orb orb-a"/><div className="sky-orb orb-b"/><div className="sky-cloud cloud-a"/><div className="sky-cloud cloud-b"><span/><span/><span/></div><div className="sky-signal"><span/><span/><span/><span/></div><div className="sky-center"><Sparkles size={30}/><b>AI CORE</b><small>THINK • BUILD • EXPLORE</small></div></div><div className="console-data"><span>AI <b>INTELLIGENCE</b></span><span>DATA <b>DISCOVERY</b></span><span>CODE <b>CREATION</b></span></div></div>
      </section>

      <section className="section about-section theme-intelligence">
        <div className="section-kicker">01 / AI Mission</div>
        <div className="about-layout"><div><h2>Building at the intersection of <em>human ideas & machine intelligence.</em></h2></div><div><p className="large-copy">I'm a developer focused on learning and building practical systems with AI, machine learning, data and modern web technology. My current work includes an academic AI chatbot using retrieval-augmented generation.</p><div className="about-stats"><div><b>AI / ML</b><span>Intelligent systems</span></div><div><b>DATA</b><span>Analytics & statistics</span></div><div><b>ROBOTICS</b><span>Autonomous concepts</span></div><div><b>QUANTUM</b><span>Emerging computing</span></div></div></div></div>
      </section>

      <section className="section theme-projects" id="projects">
        <div className="section-kicker">02 / AI Missions</div><h2>What I've <em>launched.</em></h2>
    ...
    <footer><span>© {new Date().getFullYear()} {profile.name}</span><span>AI SPACE • INTELLIGENCE • CODE • DATA</span></footer><Chatbot/>
  </div>;
}
